...
Write-Host "Para o usar: no .env, muda  OCR_MODEL=qwen3.5:9b  para  OCR_MODEL=kanban-9b"
Write-Host "e corre o update.ps1."
Write-Host "E REVERSIVEL: se o novo for pior, volta a por qwen3.5:9b e reinicia."
