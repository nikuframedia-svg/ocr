...
- **Ollama** (native Windows) serving `qwen3.5:9b`. The web OCR path uses
...
- Enough free disk for `qwen3.5:9b`; keep extra space for legacy/test
...
ollama pull qwen3.5:9b   # production OCR model
